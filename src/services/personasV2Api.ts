...
export const personasV2Api = {
   ...
   * GET /api/personas
   */
  getAll: async (params?: PersonasV2QueryParams): Promise<PersonasV2PaginatedResponse> => {
   ...
   * GET /api/personas/:id
   */
  getById: async (id: number, includeRelaciones: boolean = true): Promise<ApiResponse<PersonaV2>> => {
   ...
   * POST /api/personas
   */
  create: async (persona: CreatePersonaV2DTO): Promise<ApiResponse<PersonaV2>> => {
   ...
   * PUT /api/personas/:id
   */
  update: async (id: number, persona: UpdatePersonaV2DTO): Promise<ApiResponse<PersonaV2>> => {
